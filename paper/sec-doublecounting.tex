...
Another problem with this approach is that it introduces a dependence on the program, or even on a specific version of the program if bugs have been found.
