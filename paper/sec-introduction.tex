...
Electroweak (including combined QCD--EW) effects should therefore naturally be
incorporated in calculations for LHC processes. The reason is twofold. First,
one expects NNLO QCD and NLO EW corrections to be of
...
by default in the computation, NLO EW corrections should be
...
The systematic inclusion of EW corrections in precision computations for
...
fast-interpolation grids, accurate to up to any fixed order in the strong and
