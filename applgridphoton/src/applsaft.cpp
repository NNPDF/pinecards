...
void applsaft_lumi_add(int lumi, unsigned combinations, int* pdg_id_pairs, double factor)
{
...
int applsaft_file_open(
    ...
    assert( format == applsaft_grid_format::as_a_logmur_logmuf );
    ...
    std::string const pdf_name = "applsaft_appl_grid_pdf_bridge_" + std::to_string(index);
