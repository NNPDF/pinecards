...
from 12 (34) parton luminosities at NLO QCD (NLO QCD+EW), mainly from $q\bar{q}$
scattering, see Appendix~\ref{app:lumis} for details.
...
from $qg$ and $\bar{q}g$ scattering, see Appendix~\ref{app:lumis} for details.
