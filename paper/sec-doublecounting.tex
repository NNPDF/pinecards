...
QCD displays a remarkable agreement with another at NLO QCD+EW when the photonic shower is included.
Indeed, for the ATLAS DY measurement discussed in section~\ref{sec:dy-lepton-pair-production} the difference of the two datasets with and without shower subtractions closely resemble the size of full NLO EW effects over the entire mass range.
%(see also the behaviour of predictions showered with
