...
GRIDS_PATH="CMS_2JET_7TEV"
mkdir -p "$GRIDS_PATH"
mkdir -p "$GRIDS_PATH/tmp"

# Download and extract the grids
FILENAME="applfast-cms-dijets-v2-fc-fnlo-arxiv-1212.6660"
...
for i in {0..4}; do
    ...
    temp_dst="$GRIDS_PATH/tmp/CMS_2JET_7TEV_M12Y_BIN${j}.pineappl.lz4"
    dst="$GRIDS_PATH/CMS_2JET_7TEV_M12Y_BIN${j}.pineappl.lz4"
