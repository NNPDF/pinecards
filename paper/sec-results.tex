...
$|M_{\ell\bar\ell} - M_\mathrm{Z}| < \SI{15}{\giga\electronvolt}$,
...
is necessary as we rely on a fixed-order computation, without including resummation effects.

\paragraph{Numerical results.} We finally
