...
parton-shower {\bf MZ remove sentence if not true}. The library is included by default in 
...
supersedes \textsc{APPLgrid}~\cite{Carli:2010rw} and \textsc{aMCfast}~\cite{Bertone:2014zva}, and complements
...
comprehensive maneer the second problem sketched above, the solution of which, 
