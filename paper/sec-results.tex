...
the process has a single LO, $\mathcal{O}(\alpha_s^0\alpha^2)$; at NLO, the
QCD contribution is $\mathcal{O}(\alpha_s\alpha^2)$, while the EW contribution
is $\mathcal{O}(\alpha_s^0\alpha^3)$. The latter is not included in the NLO
...
The process receives contributions from 12 (34) parton luminosities at NLO QCD
(NLO QCD+EW), mainly from $q\bar q$ scattering. EW corrections for this process
were computed in Refs.~\cite{Baur:2001ze,Dittmaier:2009cr}.
...
were computed in Refs.~\cite{Bernreuther:2010ny,Hollik:2011ps,Kuhn:2011ri,Bernreuther:2012sx,Pagani:2016caq,Czakon:2017wor,Czakon:2017lgo,Czakon:2017mmr,Czakon:2019bcq,Czakon:2019txp}.
