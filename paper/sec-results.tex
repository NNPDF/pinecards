...
see equation~\eqref{eq:}. However, we note that
...
see secion~\ref{sec:subsec:processes_and_measurements}.
...
the Z boson, $p_\mathrm{T}^\mathrm{Z}$, measured by the CMS experiment at a
...
$\bar{\mathrm{q}}\mathrm{g}$-initiated channels, which account for about 65\%
