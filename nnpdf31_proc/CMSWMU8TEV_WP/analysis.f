...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      call HwU_book(1,'rap', 8, 0.0d0, 1.6d0)
      call HwU_book(2,'rap', 2, 1.6d0, 2.1d0)
      call HwU_book(3,'rap', 1, 2.1d0, 2.4d0)
      return
      end
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
     ...
     $                       p, iPDG, p_reco, iPDG_reco)
      ...
      xyll=getabsy(pplb(0),pplb(3))

      call HwU_fill(1,xyll,wgts)
      call HwU_fill(2,xyll,wgts)
      call HwU_fill(3,xyll,wgts)
