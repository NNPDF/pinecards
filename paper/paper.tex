...
\title{PineAPPL:\\ combining EW with QCD corrections for PDF fits}
...
\abstract{We introduce \textsc{PineAPPL}, a computer library that makes it possible to produce fast-interpolation 
