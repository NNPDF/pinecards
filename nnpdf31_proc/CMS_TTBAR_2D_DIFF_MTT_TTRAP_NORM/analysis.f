...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      double precision pttx(0:3), mtt, ytt
      ...
      if (ytt.lt.0.35d0) then
        bin = bin + 0.5d0
      elseif (ytt.lt.0.75d0) then
        bin = bin + 1.5d0
      elseif (ytt.lt.1.15d0) then
        bin = bin + 2.5d0
      elseif (ytt.lt.2.5d0) then
        bin = bin + 3.5d0
      else
      endif
