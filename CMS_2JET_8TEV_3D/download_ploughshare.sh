...
GRIDS_PATH="CMS_2JET_8TEV"
mkdir -p "$GRIDS_PATH"
mkdir -p "$GRIDS_PATH/tmp"

# Download and extract the grids
FILENAME="applfast-cms-dijets-v2-fc-fnlo-arxiv-1705.02628"
...
for i in {0..5}; do
    ...
    temp_dst="$GRIDS_PATH/tmp/CMS_2JET_8TEV_3D_BIN${j}.pineappl.lz4"
    dst="$GRIDS_PATH/CMS_2JET_8TEV_3D_BIN${j}.pineappl.lz4"
