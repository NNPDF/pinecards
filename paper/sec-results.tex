...
$\mu_F$, are chosen, for each process, as follows. In the case of Drell--Yan lepton pair
...
lepton pair, respectively. In the case of the Drell--Yan lepton-pair production at
...
\begin{figure}[!p]
    ...
    \caption{Same as Fig.~\ref{fig:atlaszhighmass49fb}, but for the CMS
      double-differential Drell--Yan lepton pair measurement at a centre-of-mass energy
...
As in the case of the ATLAS high-mass Drell--Yan measurement, the CMS measurement is
