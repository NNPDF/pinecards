...
coupling is chosen consistently with the PDF set, $\alphas(M_Z)=0.118$.
...
production at \SI{7}{\tera\electronvolt} measured by ATLAS, we require $p_T^\ell>\SI{25}{\giga\electronvolt}$,
...
at \SI{7}{\tera\electronvolt} measured by CMS, we require $p_T^{\ell_1}>\SI{14}{\giga\electronvolt}$, $p_T^{\ell_2}>\SI{9}{\giga\electronvolt}$,
...
require $p_T^\ell>\SI{25}{\giga\electronvolt}$, $|\eta_\ell|<2.4$,
$M_Z-\SI{15}{\giga\electronvolt}<M_{\ell\bar\ell}<M_Z+\SI{20}{\giga\electronvolt}$,
$|\eta_{\ell\bar\ell}|<2.4$ and $\SI{20}{\giga\electronvolt}<p_T^{\ell\bar\ell}<\SI{1500}{\giga\electronvolt}$ for the
...
mass bin comes from
the $u\bar{u}$ ($d\bar{d}$) parton luminosity, which accounts for about \SI{70}{\percent}
...
($u\bar{u}$) parton luminosity, which accounts for about \SI{60}{\percent} (\SI{44}{\percent}) of the
